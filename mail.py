...
def send_no_llm_processing_email(papers_with_abstracts, query, today, last_week, config, paper_count, max_papers_for_llm):
    ...
    """
    def format_no_llm_email_content(papers_with_abstracts, query, today, last_week, paper_count, max_papers_for_llm):
        """Format email content when LLM processing is skipped."""
        html_content = f"""
        <html>
        <head>
            <style>
        ...
        html_content += f"""
            ...
            <div class="footer">
                ...
                LLM processing was skipped to prevent excessive API usage.
            </div>
        </body>
        </html>
        """
    ...
    # Format email content
    html_content = format_no_llm_email_content(papers_with_abstracts, query, today, last_week, paper_count, max_papers_for_llm)
